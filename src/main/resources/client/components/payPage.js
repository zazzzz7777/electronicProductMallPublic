Vue.component('pay-form',{
    ...
    <el-dialog :visible.sync="payVisible" :title="'支付'" width="60%" destroy-on-close>
      ...
      <div class="payList">
        <div class="payView" style="display: flex;align-items: center">
          <el-radio v-model="payType" label="微信支付"></el-radio>
          <img :src="baseUrl+'client/static/img/pay_icon/weixin.png'" alt>
        </div>
        <div class="payView" style="display: flex;align-items: center">
          <el-radio v-model="payType" label="支付宝支付"></el-radio>
          <img :src="baseUrl+'client/static/img/pay_icon/zhifubao.png'" alt>
        </div>
        <div class="payView" style="display: flex;align-items: center">
          <el-radio v-model="payType" label="建设银行"></el-radio>
          <img :src="baseUrl+'client/static/img/pay_icon/jianshe.png'" alt>
        </div>
        <div class="payView" style="display: flex;align-items: center">
          <el-radio v-model="payType" label="农业银行"></el-radio>
          <img :src="baseUrl+'client/static/img/pay_icon/nongye.png'" alt>
        </div>
        <div class="payView" style="display: flex;align-items: center">
          <el-radio v-model="payType" label="中国银行"></el-radio>
          <img :src="baseUrl+'client/static/img/pay_icon/zhongguo.png'" alt>
        </div>
        <div class="payView" style="display: flex;align-items: center">
          <el-radio v-model="payType" label="交通银行"></el-radio>
          <img :src="baseUrl+'client/static/img/pay_icon/jiaotong.png'" alt>
        </div>
      </div>
      <template #footer>
